...
/*
Створи масив чисел від start до end
Відсортуйте їх у випадковому порядку
При кожному наступному виклику повертай наступне число
Коли числа закінчилися, повертай null */
